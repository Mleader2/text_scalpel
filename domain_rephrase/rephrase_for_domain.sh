...
python predict_for_domain.py \
  --input_file=/home/${HOST_NAME}/Mywork/corpus/ner_corpus/domain_corpus/train4.csv \
  --input_format=wikisplit \
  --output_file=/home/${HOST_NAME}/Mywork/corpus/ner_corpus/domain_corpus/train4_expand.csv \
  --label_map_file=${OUTPUT_DIR}/label_map.txt \
